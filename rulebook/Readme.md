...
进攻方对抗失败不造成负面影响 进攻方对抗同级和成功无论级数差距均只造成一点轻伤，面对物理防御时，成功级数差为2级时，防守方会受到崩防效果，跳过自己下一个行动回合，差为3级及以上时，防守方跳过自己下两个行动回合。  
...
0-40距离近战防守方可以进行反击，同时距离拉近为0.远程防守方均可进行反击。
...
战斗时的对抗会根据双方所选择的指令对应的属性roll 100面骰。
按照防御指令中的成功级数标识则为：  
1：0级 超级大成功  
2-四分之一属性：1级 极大成功  
